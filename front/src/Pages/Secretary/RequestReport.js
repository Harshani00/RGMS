...
//   // Sample hardcoded application data
...
//             <label>Grantted Application </label>
...
//               <td>
//                 <button className="btn btn-primary" onClick={() => handleView(app.id, 'mid')}>View</button>
//                 <button className="btn btn-secondary" onClick={() => handleSendEmail(app.id, 'mid')}>Send Email</button>
//               </td>
//               <td>
//                 <button className="btn btn-primary" onClick={() => handleView(app.id, 'end')}>View</button>
//                 <button className="btn btn-secondary" onClick={() => handleSendEmail(app.id, 'end')}>Send Email</button>
//               </td>
//               <td>
//                 <button className="btn btn-primary" onClick={() => handleView(app.id, 'final')}>View</button>
//                 <button className="btn btn-secondary" onClick={() => handleSendEmail(app.id, 'final')}>Send Email</button>
//               </td>
//             </tr>
//           ))}
//         </tbody>
...
// const handleSendEmail = (id, reportType) => {
//   console.log(`Sending email for ${reportType} report for application ${id}`);
//   // Add logic to send the email for the
// };
