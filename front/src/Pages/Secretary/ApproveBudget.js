...
//     // Determine the file type based on reportType
//     const fileType = reportType === 'previous' ? 'PreviousBudget' : 'CurrentBudget';
//     const filePath = `${id}_Budget(${fileType}).pdf`;  // Construct file name
  
//     // Prepare the URL for requesting the budget file
//     const downloadUrl = `/ApproveBudget.php?app_ID=${id}&filePath=${filePath}`;
