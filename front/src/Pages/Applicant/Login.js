...
export default function LoginForm() {
  ...
  //       const { user_name, user_role, userId } = response.data;
  //       console.log('User Role from API:', user_role); // Check user role in console
  //       console.log('User ID from API:', userId); // Check user ID in console
  ...
  //       localStorage.setItem('user_id', userId); // Save the user_id in local storage
